...
namespace turtlelib
{
    ...
    private:
        ...
        {
            __trans_matrix[0][0] = cos(__twist.omega);
            __trans_matrix[0][1] = -sin(__twist.omega);
            __trans_matrix[0][2] = __twist.x;

            __trans_matrix[1][0] = sin(__twist.omega);
            __trans_matrix[1][1] = cos(__twist.omega);
            __trans_matrix[1][2] = __twist.y;

            __trans_matrix[2][0] = 0.0;
            __trans_matrix[2][1] = 0.0;
            __trans_matrix[2][2] = 1.0;
        }
    };
